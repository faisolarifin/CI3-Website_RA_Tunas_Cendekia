<section class="big-content y-content">
	<div class="container">
		<div class="row mb-2">
			<div class="col">
				<span class="badge badge-success"><i class="fa fa-home"></i> <i class="fa fa-angle-double-right"></i> Artikel</span>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-8 mb-4">
				...
				<div class="row mb-4 wow fadeInUp">
					<div class="col-11">
						...
						<a href="<?= base_url().'artikel/posted/'.$row->uni_url; ?>"><button class="btn btn-primary btn-more">LEBIH LENGKAP</button></a>
					</div>
