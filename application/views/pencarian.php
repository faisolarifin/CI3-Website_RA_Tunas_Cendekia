<section class="big-content y-content">
	<div class="container">
		<div class="row mb-2">
			<div class="col">
				<span class="badge badge-success"><i class="fa fa-home"></i> <i class="fa fa-angle-double-right"></i> Pencarian</span>
			</div>
		</div>
		<div class="row">
				...
				<div class="row">
					<div class="col">
						...
						?>
							<div class="row mb-4 wow fadeInUp">
								<div class="col-11">
									<h4>Pencarian anda <u class="font-italic"><?= $this->input->get('keyword'); ?></u> tidak ditemukan pada postingan.</h4>
								</div>
							</div>
						<?php
							endif;
