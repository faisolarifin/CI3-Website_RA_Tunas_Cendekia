...
<head>
	...
	<title>Tunas Cendikia | Login</title>
								...
								<div class="p-5">
									...
									<form class="user" method="post" action="<?= base_url();?>auth">
										<div class="form-group">
											<input type="text" class="form-control form-control-user" name="username" id="username" value="<?= set_value('email'); ?>" placeholder="Masukkan Username Anda...">
